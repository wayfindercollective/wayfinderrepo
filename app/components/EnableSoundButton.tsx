  ...
  return (
    <div className="flex flex-col items-center">
      <button
        ...
        ref={buttonRef}
        onClick={handleClick}
        className={`px-6 py-3 bg-black border-2 border-white rounded text-[#00FFFF] text-3xl font-bold cursor-pointer hover:bg-[#0a0a0a] hover:shadow-[0_0_15px_rgba(0,255,255,0.5)] button-shimmer ${exo2.variable} mt-[8vh] md:mt-[45px]`}
        style={{ 
