...
export default function HeroLogo() {
  ...
  return (
    <section className="relative text-white overflow-visible bg-transparent">
      ...
      <div 
        ref={logoRef}
        className="relative w-fit max-w-[85vw] md:max-w-[90vw] mx-auto -mt-10 md:-mt-55 mb-[1vh] md:mb-0 group z-10 scale-100 md:scale-[0.75]"
      ...
      >
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-[68%] z-[30] mt-0" style={{ pointerEvents: 'auto' }}>
          <EnableSoundButton />
        </div>
      </div>
    </section>
